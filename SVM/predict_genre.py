...
def predict_genre(lyrics, model, tfidf_vectorizer, pos_vectorizer, scaler):
...
# """
    ...
    genre_prediction = predict_genre(lyrics, svm_model, tfidf_vectorizer, pos_vectorizer, scaler)
